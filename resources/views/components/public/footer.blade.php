            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center gap-3 mb-6">
                    @if(!empty($settings['site_logo']))
                        <img class="h-10 w-auto rounded-full grayscale opacity-80" src="{{ $settings['site_logo'] }}" alt="Logo">
                    @endif
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ $settings['instagram_url'] }}" target="_blank" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-600 hover:text-white transition">
